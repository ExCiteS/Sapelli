 ...
 * 
 */
package uk.ac.ucl.excites.sapelli.collector.project;
...
public class ProjectModelProvider implements ModelProvider
{
	...
	/* (non-Javadoc)
	 * @see uk.ac.ucl.excites.sapelli.transmission.ModelProvider#getSchema(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.ucl.excites.sapelli.transmission.ModelProvider#getSettingsFor(uk.ac.ucl.excites.sapelli.storage.model.Schema)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.ucl.excites.sapelli.transmission.ModelProvider#getFactoredOutColumnsFor(uk.ac.ucl.excites.sapelli.storage.model.Schema)
	 */
	@Override
