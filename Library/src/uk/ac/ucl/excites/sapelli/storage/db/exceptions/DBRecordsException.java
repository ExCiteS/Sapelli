...
public class DBRecordsException extends DBException
{
	 ...
	 * @param cause
	 */
	public DBRecordsException(String detailMessage, Throwable cause)
	{
	 ...
	 * @param records
	 */
	public DBRecordsException(String detailMessage, Throwable cause, Record... records)
	{
	 ...
	 * @param detailMessage
	 */
	public DBRecordsException(String detailMessage)
	{
	 ...
	 * @param records
	 */
	public DBRecordsException(String detailMessage, Record... records)
	{
		super(detailMessage);
		addRecords(records);
	}
	 ...
	 * @param records
	 */
	public DBRecordsException(Throwable cause, Record... records)
	{
		super(cause);
		addRecords(records);
	}
