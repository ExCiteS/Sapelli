...
public class DateTimeColumn extends Column<DateTime>
{
	...
	/**
	 * Note (2013-07-13):
	 * 	Implementation used to be: return DateTimeZone.forTimeZone(uk.ac.ucl.excites.sapelli.util.TimeUtils.getTimeZone(quarterHourOffset * QUARTER_OF_AN_HOUR_MS));
