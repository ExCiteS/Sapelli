 ...
 * 
 * Based on an example full-screen activity that shows and hides the system UI (i.e. status bar and navigation/system bar) with user interaction.
 * 
 * @see SystemUiHider
 * @author mstevens
 */
public class CollectorActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//TODO get Project name from bundle
		String projectName = "Test";
		
		//Get DataAccess object
		String dbPath = "?"; //TODO db path
		dao = DataAccess.getInstance(dbPath);
		
		//Get Project object:
		project = null; //TODO get project with projectName + error handling if not found
