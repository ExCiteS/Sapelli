 ...
 */
/*
 * public static void stopService(Context context) { while(isMyServiceRunning(context, DATA_SENDER_SERVICE)) { // Terminate the service Intent intent = new
 * Intent(context, DataSenderService.class); if(context.stopService(intent)) Debug.d("Service Stoped"); else Debug.d("Cannot Stop the Service."); } } }
 */