...
public class AndroidControlsUI extends ControlsUI<View, CollectorView>
{
	...
	@Override
	public void update(Form currentForm, FieldUI<?, View, CollectorView> currentFieldUI)
	{
		if(view != null)
			view.update(currentForm, currentFieldUI);
	}
	...
	{
		//TODO clean-up ...
		return (view.currentState.isAnyButtonShown() ? (view.getButtonHeightPx() + collectorUI.getSpacingPx()) : 0);
	}
	...
	private class ControlsView extends PickerView implements AdapterView.OnItemClickListener
	{
		...
		{	
			...
			ControlsState newState = new ControlsState(currentFieldUI.isShowBack(), currentFieldUI.isShowCancel(), currentFieldUI.isShowForward());
		...
		public void onItemClick(AdapterView<?> parent, View v, final int position, long id)
		{
			...
			Runnable action = new Runnable()
			{
				public void run()
				{
					onButtonClick(positionToButton[position]);
				}
			};
