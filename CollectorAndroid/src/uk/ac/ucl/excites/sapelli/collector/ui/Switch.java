...
/**
 * https://bitbucket.org/ankri/switchbutton/src
 * 
...
public class Switch extends CompoundButton
{
	...
	public Switch(Context context, AttributeSet attrs, int defStyle) {
		...
		this.switchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_switchMinWidth1, 200);
		...
		this.switchPadding = a.getDimensionPixelSize(R.styleable.Switch_switchPadding1, 32);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		final int switchHeight = this.drawableSwitch.getIntrinsicHeight();
