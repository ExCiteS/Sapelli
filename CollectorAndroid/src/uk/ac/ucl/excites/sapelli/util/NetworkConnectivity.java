 ...
 * 
 * Based on: http://stackoverflow.com/a/8548926/1084488
 * 
 * @author mstevens
...
public final class NetworkConnectivity
{
	...
	{
		if(type == ConnectivityManager.TYPE_WIFI || type == ConnectivityManager.TYPE_ETHERNET || type == ConnectivityManager.TYPE_WIMAX)
		{
			return true;
		}
