 ...
 * </pre>
 * 
 * Copyright (C) 2014 Jared Rummler (jared.rummler@gmail.com)<br/>
 * Licensed under Apache License, Version 2.0.<br/>
 * Minor modification by mstevens (see commented line).<br/>
 * 
 * @author Jared Rummler (jared.rummler@gmail.com)
 * @since Dec 11, 2014
 * @see https://gist.github.com/jaredrummler/ec7dfb73f3235ad8e951
 * @see http://stackoverflow.com/a/28021292/1084488
 */
public class MenuColorizer
{
	...
	public static void colorMenu(final Activity activity, final Menu menu, final int color, final int alpha)
	{
		...
		final View home = ViewHelpers.getActionBarHomeView(activity); // modified by mstevens
		if(home != null)
		{
	...
	public static void colorMenuItem(final MenuItem menuItem, final int color, final int alpha)
	{
		...
		if(drawable != null)
		{
			// If we don't mutate the drawable, then all drawable's with this id will have a color filter applied to it.
			drawable.mutate();
